  ...
  return (
    <>
      ...
      <main className="w-full">
        <HeroSection />
        <Steps />
        <div className="w-full py-12 max-lg:flex max-lg:flex-col max-lg:items-center lg:px-[417px] ">
          <div className="flex">
            ...
            <aside className="bg-zinc-100 lg:max-h-[628px] flex flex-col gap-4 items-start p-6 mx-2 lg:w-[50%] rounded-md">
              ...
              <p className="max-w-[300px] max-lg:text-sm text-zinc-500">
                Pronto para transformar sua ideia em realidade? Fale com a
                gente.
              </p>
              ...
              <div className=" w-full  flex gap-2">
                <div className="bg-[#FF8C00]/64 size-10 rounded-md flex items-center justify-center">
                  <Phone className="text-white" />
                </div>
                <div className="flex flex-col">
                  <h4 className="font-medium text-sm">Whatsapp</h4>
                  <p className="text-zinc-500 text-sm">(88)88888-8888</p>
                </div>
              </div>
              <div className=" w-full flex gap-2">
                <div className="bg-[#FF8C00]/64 size-10 rounded-md flex items-center justify-center">
